...
const TravelInfoCheckIn = (props: Props) => {
  ...
  return (
    <Layout>
        <div className = "relative h-[150rem] overflow-y-auto overflow-x-clip bg-slate-50 bottom-[2rem] small:bottom-[0rem] medium:bottom-[0rem] big:bottom-[0rem]">
            {/* online check-in */}
            <div className = "relative left-[12vw] top-[1rem] font-space-grotesk w-[75vw]">
                ...
                <div className = "relative top-[5rem]" id = "airport">
                    ...
                    <div className = "flex">
                        <div>
                            <div className = {guideStep === 1 ? "hover:bg-[#ebc94e] w-[21vw] h-[4rem] text-left border-white border-x-[1px] border-y-[1px] border-solid hover:cursor-pointer bg-[#ebc94e]" : "hover:bg-[#ebc94e] w-[21vw] h-[4rem] text-left border-white border-x-[1px] border-y-[1px] border-solid hover:cursor-pointer bg-[#d5dadb]"} onClick = {() => setGuideStep(1)}>
                                <p className = "text-2xl font-bold relative bottom-[1rem] left-[1rem]">Step 1</p>
                            </div>
                            <div className = {guideStep === 2 ? "hover:bg-[#ebc94e] w-[21vw] h-[4rem] text-left border-white border-x-[1px] border-y-[1px] border-solid hover:cursor-pointer bg-[#ebc94e]" : "hover:bg-[#ebc94e] w-[21vw] h-[4rem] text-left border-white border-x-[1px] border-y-[1px] border-solid hover:cursor-pointer bg-[#d5dadb]"} onClick = {() => setGuideStep(2)}>
                                <p className = "text-2xl font-bold relative bottom-[1rem] left-[1rem]">Step 2</p>
                            </div>
                            <div className = {guideStep === 3 ? "hover:bg-[#ebc94e] w-[21vw] h-[4rem] text-left border-white border-x-[1px] border-y-[1px] border-solid hover:cursor-pointer bg-[#ebc94e]" : "hover:bg-[#ebc94e] w-[21vw] h-[4rem] text-left border-white border-x-[1px] border-y-[1px] border-solid hover:cursor-pointer bg-[#d5dadb]"} onClick = {() => setGuideStep(3)}>
                                <p className = "text-2xl font-bold relative bottom-[1rem] left-[1rem]">Step 3</p>
                            </div>
                            <div className = {guideStep === 4 ? "hover:bg-[#ebc94e] w-[21vw] h-[4rem] text-left border-white border-x-[1px] border-y-[1px] border-solid hover:cursor-pointer bg-[#ebc94e]" : "hover:bg-[#ebc94e] w-[21vw] h-[4rem] text-left border-white border-x-[1px] border-y-[1px] border-solid hover:cursor-pointer bg-[#d5dadb]"} onClick = {() => setGuideStep(4)}>
                                <p className = "text-2xl font-bold relative bottom-[1rem] left-[1rem]">Step 4</p>
                            </div>
                            <div className = {guideStep === 5 ? "hover:bg-[#ebc94e] w-[21vw] h-[4rem] text-left border-white border-x-[1px] border-y-[1px] border-solid hover:cursor-pointer bg-[#ebc94e]" : "hover:bg-[#ebc94e] w-[21vw] h-[4rem] text-left border-white border-x-[1px] border-y-[1px] border-solid hover:cursor-pointer bg-[#d5dadb]"} onClick = {() => setGuideStep(5)}>
                                <p className = "text-2xl font-bold relative bottom-[1rem] left-[1rem]">Step 5</p>
                            </div>
                        </div>
                        <div className = "bg-[#1A4532] w-[52vw] h-[20.4rem] border-white border-x-[1px] border-y-[1px] border-solid text-[#ebc94e]">
                            {guideStep === 1 && 
                                <div className = "relative left-[1rem] w-[48vw] fadeIn">
                                    <p className = "text-lg font-bold small:text-[14px]">At check-in counter </p>
                                    <p className = "text-lg relative bottom-[1rem] small:text-[14px]">At the airport, please follow the electronic board displaying flight information at the terminal for your check-in counter. Upon arrival at the counter, ground service staff shall check your PNR/ ticket number and your travel documents. Check-in baggage will be placed on the conveyor belt for weighing and transported separately. </p>
                                </div>
                            }
                            {guideStep === 2 && 
                                <div className = "relative left-[1rem] w-[48vw] fadeIn">
                                    <p className = "text-lg font-bold small:text-[14px]">Receive boarding pass </p>
                                    <p className = "text-lg relative bottom-[1rem] small:text-[14px]">Upon completion of check-in procedures, ground service staff shall return your documents and boarding pass stating boarding gate. </p>
                                </div>
                            }
                            {guideStep === 3 && 
                                <div className = "relative left-[1rem] w-[48vw] fadeIn">
                                    <p className = "text-lg font-bold small:text-[14px]">At security area </p>
                                    <p className = "text-lg relative bottom-[1rem] small:text-[14px]">Upon receiving boarding pass, please go to the security area. Then, you shall be required to take off your belongings such as watch, shoes, bag, belt... then put them into a tray and go through screening machine. </p>
                                </div>
                            }
                            {guideStep === 4 && 
                                <div className = "relative left-[1rem] w-[48vw] fadeIn">
                                    <p className = "text-lg font-bold small:text-[14px]">At boarding gate </p>
                                    <p className = "text-lg relative bottom-[1rem] small:text-[13px]">Passengers are advised to be present at boarding gate around 30 to 40 minutes before departure time. Upon waiting for boarding, passengers with Business cabin tickets or Voucher for Business lounge entrance are welcomed to use our First Lounge. At least 15 minutes before departure time, if you are not at the designated boarding gate, AHA Airlines shall mark you as no-show and proceed accordingly to our regulations. </p>
                                </div>
                            }
                            {guideStep === 5 && 
                                <div className = "relative left-[1rem] w-[48vw] fadeIn">
                                    <p className = "text-lg font-bold small:text-[14px]">Boarding </p>
                                    <p className = "text-lg relative bottom-[1rem] small:text-[14px]">After boarding the plane, please go to the right seat number stated on the ticket. Don't forget to put your suitcase, backpack or belongings in the overhead luggage compartment then close the door and sit down, fasten your seat belt and wait for the plane to take off. </p>
                                </div>
                            }
                        </div>
                    </div>
